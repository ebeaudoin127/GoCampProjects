// ============================================================
// Fichier : AccommodationType.java
// Dernière modification : 2026-04-16
// Auteur : ChatGPT
//
// Résumé :
// - Entité de référence pour les types d’hébergement
// ============================================================
...
@Table(
        ...
        indexes = {
                @Index(name = "idx_accommodation_type_active", columnList = "is_active"),
                @Index(name = "idx_accommodation_type_display_order", columnList = "display_order")
        }
)
