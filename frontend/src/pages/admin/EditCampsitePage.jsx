    ...
    const loadPage = async () => {
      ...
      try {
        ...
        setForm({
          ...
          hasWater: !!siteData.hasWater,
          hasElectricity: !!siteData.hasElectricity,
          hasSewer: !!siteData.hasSewer,

          has15_20Amp: !!siteData.has15_20Amp,
          has30Amp: !!siteData.has30Amp,
          has50Amp: !!siteData.has50Amp,
